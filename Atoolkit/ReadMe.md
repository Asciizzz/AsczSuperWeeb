...
| **[`acircuit`](./acircuit/ReadMe.md)** | Value Computation Circuit | Directed computation circuit with typed socket endpoints (`Socket`), 1-to-N fan-out (`Wire`), computational nodes (`CircuitNode`), Kahn topological ordering, and static graph validation. | [acircuit ReadMe](./acircuit/ReadMe.md) |
