import type { CompiledShaderBlueprint, ShaderGraph } from "./graph.js";
import type { ShaderParamLayout } from "./types.js";
import { ShaderParamsCmp } from "./params.js";
...
export class Shader {
    ...
    /**
     * Clears all cached GPU resources to allow hot-reloading or recompiling.
     */
    invalidateGpu(): void {
        this.pipeline = null;
     ...
     * Arrays are cloned to prevent mutating internal blueprint defaults.
     */
    ...
    createParamsCmp(overrides?: MaterialParamRecord): ShaderParamsCmp {
        ...
        return new ShaderParamsCmp(params, this);
    }
